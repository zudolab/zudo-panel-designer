...
// handles, and extraSubpaths; pattern is returned unchanged — it carries an
// x/y/size square since #96, but pattern scaling stays excluded (the
// renderer's multi-resize gate is unchanged) until the interaction sub.
