...
registerTool({
  ...
  cursor: 'default',
  description:
    'Click a layer to select it, then drag to move it; click empty space to deselect. With a layer ' +
    'selected, drag its handles to resize (shapes/images) or its anchors and bezier handles to reshape ' +
    'a path. Arrow keys nudge the selection (Shift = ×10); Delete/Backspace removes it. Shortcut: V.',
