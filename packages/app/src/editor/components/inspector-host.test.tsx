...
describe('InspectorHost onChange (#150)', () => {
  it('edits a depth-2 nested leaf in place, preserving group structure and sibling identity', () => {
    ...
    render(<InspectorHost ctx={ctx} doc={doc} activeSide="front" layer={leaf} selectedIds={['deep']} />);
  ...
  it('uses the committed render doc for material context and patches, not a lagging ctx ref', () => {
    ...
    render(
      <InspectorHost ctx={ctx} doc={committedDoc} activeSide="front" layer={movedLeaf} selectedIds={['moving']} />,
    );
